...
Original file is located at
    https://colab.research.google.com/drive/1nubLR26QxEXqIcbk_PQwIhfDOKPTUBfY
"""
...
def merge_mp3s(singer_name, save_path=SAVE_PATH, outputfilename="mashup.mp3"):
...
def main():
    if len(sys.argv) != 5:
        print(
            "Usage: python 102103241.py <singer_name> <num_videos> <duration> <outputfilename>"
        )
        return
