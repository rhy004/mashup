...
Original file is located at
    https://colab.research.google.com/drive/1oThiwUjTb1meXOBXaDPTHzu1uww2UQXf
"""
...
def merge_mp3s(singer_name, save_path, outputfilename):
    final_mp3_path = os.path.join(save_path, outputfilename)
    mp3s = [
        os.path.join(save_path, mp3) for mp3 in os.listdir(save_path) if mp3.endswith(".mp3")
    ]
